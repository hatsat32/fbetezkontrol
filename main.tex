...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.9\linewidth]{images/s2/image-type-by-periods.png}
...
Tablo~\ref{tab:oldest-cves-count}'da taramalar sonucunda tüm imajlar içerisinde tespit edilen en eski CVE'ler ve bunların tespit edilme sıklıkları listelenmiştir. Dikkat çekici bir şekilde, çok eski CVE'ler hala Docker imajlarında bulunabilmektedir.
